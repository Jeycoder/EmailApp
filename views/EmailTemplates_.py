...
def clickSelector(event):
    ...
    Vsubject.set(table.item(item, "values")[2])
    Vmessage.set(table.item(item, "values")[3])
...
def update():
    ...
    try:
        ...
        messagebox.showwarning("WARNING", "An error has occurred trying to update the list")
        pass
    show()
...
buttonUpdate = Button(window, text="Update Template", command=update)
buttonUpdate.place(x=250, y=420)
